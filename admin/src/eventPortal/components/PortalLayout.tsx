    ...
    <div style={{ minHeight: '100vh', background: '#fff7ed' }}>
      ...
      >
        ...
        <nav style={{ display: 'flex', gap: 8, flex: 1, flexWrap: 'wrap' }}>
          <NavLink to="/evento/dashboard" style={navStyle}>
            Resumo
          </NavLink>
          <NavLink to="/evento/produtos" style={navStyle}>
            Produtos
          </NavLink>
          <NavLink to="/evento/vendas" style={navStyle}>
            Vendas
          </NavLink>
          <NavLink to="/evento/totens" style={navStyle}>
            Totens
          </NavLink>
          <NavLink to="/evento/operadores" style={navStyle}>
            Operadores
          </NavLink>
        </nav>
        <button
